...
import { GbClientService } from '../services/gbClient/gb-client.service';
...
export class HomeComponent implements OnInit {
  ...
  constructor(
    ...
    private githubClient: GbClientService,
  ...
  onSearch = (event) => {
    ...
    this.githubClient.getJSONRepos(target.value).then((response) => {
      target.blur();
      this.selectedTab = 1;
